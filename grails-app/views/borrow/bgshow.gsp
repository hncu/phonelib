		...
		<div id="show-borrow" class="content scaffold-show" role="main">
			...
			<ol class="property-list borrow">
				...
				<li class="fieldcontain">
					<span id="book-label" class="property-label"><g:message code="borrow.book.label" default="Book" /></span>
						...
						<span class="property-value" aria-labelledby="book-label"><g:link controller="book" action="bgshow" id="${borrowInstance?.book?.id}">${borrowInstance?.book?.title?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="borrower-label" class="property-label"><g:message code="borrow.borrower.label" default="Borrower" /></span>
						...
						<span class="property-value" aria-labelledby="borrower-label"><g:link controller="shiroUser" action="bgshow" id="${borrowInstance?.borrower?.id}">${borrowInstance?.borrower?.username?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="owner-label" class="property-label"><g:message code="borrow.owner.label" default="Owner" /></span>
						...
						<span class="property-value" aria-labelledby="owner-label"><g:link controller="shiroUser" action="bgshow" id="${borrowInstance?.owner?.id}">${borrowInstance?.owner?.username?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="bgedit" id="${borrowInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
