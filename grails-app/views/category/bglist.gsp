			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="cname" title="${message(code: 'category.cname.label', default: 'Cname')}" />
				...
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="bgshow" id="${categoryInstance.id}">${fieldValue(bean: categoryInstance, field: "cname")}</g:link></td>
