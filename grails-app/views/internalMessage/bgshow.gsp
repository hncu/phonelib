		...
		<div id="show-internalMessage" class="content scaffold-show" role="main">
			...
			<ol class="property-list internalMessage">
				...
				<li class="fieldcontain">
					<span id="recipient-label" class="property-label"><g:message code="internalMessage.recipient.label" default="Recipient" /></span>
						...
						<span class="property-value" aria-labelledby="recipient-label"><g:link controller="shiroUser" action="bgshow" id="${internalMessageInstance?.recipient?.id}">${internalMessageInstance?.recipient?.username?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="sender-label" class="property-label"><g:message code="internalMessage.sender.label" default="Sender" /></span>
						...
						<span class="property-value" aria-labelledby="sender-label"><g:link controller="shiroUser" action="bgshow" id="${internalMessageInstance?.sender?.id}">${internalMessageInstance?.sender?.username?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="bgedit" id="${internalMessageInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
