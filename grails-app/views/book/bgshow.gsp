		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="book.category.label" default="Category" /></span>
						...
						<span class="property-value" aria-labelledby="category-label"><g:link controller="category" action="bgshow" id="${bookInstance?.category?.id}">${bookInstance?.category?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${bookInstance?.own}">
				<li class="fieldcontain">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="bgedit" id="${bookInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
